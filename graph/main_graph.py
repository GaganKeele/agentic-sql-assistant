...
from graph.sql_subgraph import sql_subgraph
...
def create_main_graph():
    ...
    builder.add_node("to_sql_generation", sql_subgraph)   # ← SQL subgraph
    ...
    # Now routes to REAL sql subgraph
    builder.add_conditional_edges(
        "classify_questions",
        question_type_router,
        {
            "sql": "to_sql_generation",
            "general": "narrative_ans"
        }
    )

    builder.add_edge("to_sql_generation", "update_history")
